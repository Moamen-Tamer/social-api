...
export const getCommentsRedis = async (postId: string): Promise<unknown[] | null> => {
...
export const deleteCommentOnPost = async (authorId: string, postId: string, commentId: string) => {
